...
var ComponentType = (function () {
    function ComponentType(componentName, allocator) {
        ...
        ComponentType.nameToReleaseFn[componentName] = function (t) { _this.release(t); };
    }
    ComponentType.prototype.allocate = function () { return this.allocator.allocate(); };
    ComponentType.prototype.release = function (t) { this.allocator.release(t); };
...
var Group1 = (function (_super) {
    ...
    function Group1(context, t) {
        var _this = _super.call(this, context, function (entity) { return typeof entity.components[t.componentName] !== 'undefined'; }) || this;
...
var Group2 = (function (_super) {
    ...
    function Group2(context, t, u) {
        var _this = _super.call(this, context, function (entity) {
...
var Group3 = (function (_super) {
    ...
    Group3.prototype.each = function (cb) {
        for (var _i = 0, _a = this.entities; _i < _a.length; _i++) {
            var entity = _a[_i];
            cb(entity.components[this.tName], entity.components[this.uName], entity.components[this.vName], entity);
        }
    };
    return Group3;
}(Group));
...
(function (Simulation) {
    var vecAllocator = {
        allocate: function () { return Vec2.allocateFromPool(); },
        release: function (v) { v.returnToPool(); }
    };
    ...
    var RigidBodyInfo = (function () {
        ...
        RigidBodyInfo.prototype.clear = function () { this.force.clear(); this.mass = 1.0; };
        return RigidBodyInfo;
    }());
    var RigidBody = new ComponentType("RigidBody", new PoolAllocator(RigidBodyInfo));
    ...
    var ParticleAppearanceInfo = (function () {
        ...
        ParticleAppearanceInfo.prototype.set = function (radius, color) { this.radius = radius; this.color = color; };
    ...
    var ParticleAppearance = new ComponentType("ParticleAppearance", new PoolAllocator(ParticleAppearanceInfo));
...
var Vec2 = (function () {
    ...
    Vec2.prototype.set = function (x, y) { this.x = x; this.y = y; };
    Vec2.prototype.copyFrom = function (other) { this.x = other.x; this.y = other.y; };
    Vec2.prototype.clear = function () { this.x = 0; this.y = 0; };
    Vec2.allocateFromPool = function () { return Vec2.freeList.pop() || new Vec2(); };
    Vec2.prototype.returnToPool = function () { Vec2.freeList.push(this); };
    return Vec2;
}());
// Memory pooling
Vec2.freeList = [];
